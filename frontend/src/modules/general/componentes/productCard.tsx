        ...
        <article className="w-full max-w-[280px] mx-auto">
            ...
            <div className="space-y-1 py-[10px] w-full">
                ...
                <div className="flex gap-2 mt-2">
                    ...
                    <button
                        onClick={onBuyClick}
                        className="px-4 py-4 w-full cursor-pointer flex-[3] h-[25px] bg-[#57634A] text-white text-sm font-medium rounded-[6px] hover:cursor-pointer hover:bg-[#465237] transition-colors duration-200 flex items-center justify-center gap-2"
                    >
