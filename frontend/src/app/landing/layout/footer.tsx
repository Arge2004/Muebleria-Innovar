...
export default function Footer() {
    return (
        <footer className="bg-[#F5F3ED] text-gray-800 py-12 px-8 md:px-14">
            <div className="max-w-7xl mx-auto">
                {/* Top Section */}
                <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] 2xl:grid-cols-[300px_1fr] place-content-center place-items-center gap-8 mb-8">
                    {/* Logo and Contact Info */}
                    <div className="flex flex-col items-start">
                        <div className="flex items-center gap-3 mb-4">
                            <Image src={logo} alt="Logo Galería Innovar" width={50} height={50} />
                            <h2 className="text-xl font-semibold text-gray-800">Galeria Innovar</h2>
                        </div>
                    ...
                    <div className="text-center w-full ">
                        <div>
                            ...
                            <nav>
                                <ul className="flex justify-center gap-4 text-sm text-gray-700">
                                    <li>
