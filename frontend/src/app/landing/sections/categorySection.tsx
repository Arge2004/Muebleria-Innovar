...
import { categories } from '@/app/landing/data/categories'
      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="text-center mb-4 flex-shrink-0">
          <h2 className="text-3xl font-bold italic">
            Convierte cada espacio en tu hogar <br /> soñado con nuestros muebles exclusivos.
          </h2>
        </div>

        {/* Grid de categorías */}
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 grid-rows-2 gap-2.5 py-3">
